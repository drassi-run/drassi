...
func addFlags(flags *pflag.FlagSet) *containerOptions {
	...
	flags.StringVarP(&copts.hostname, "hostname", "h", "", "ContainerBase host name")
	flags.StringVar(&copts.domainname, "domainname", "", "ContainerBase NIS domain name")
...
'':        Use the cgroup namespace as configured by the
	...
	flags.Var(&copts.linkLocalIPs, "link-local-ip", "ContainerBase IPv4/IPv6 link-local addresses")
	flags.StringVar(&copts.macAddress, "mac-address", "", "ContainerBase MAC address (e.g., 92:d0:c6:0a:29:33)")
	...
	flags.StringVar(&copts.isolation, "isolation", "", "ContainerBase isolation technology")
