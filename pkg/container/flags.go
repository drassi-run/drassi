...
func addFlags(flags *pflag.FlagSet) *containerOptions {
	...
	flags.StringVarP(&copts.hostname, "hostname", "h", "", "ContainerBs host name")
	flags.StringVar(&copts.domainname, "domainname", "", "ContainerBs NIS domain name")
...
'':        Use the cgroup namespace as configured by the
	...
	flags.Var(&copts.linkLocalIPs, "link-local-ip", "ContainerBs IPv4/IPv6 link-local addresses")
	flags.StringVar(&copts.macAddress, "mac-address", "", "ContainerBs MAC address (e.g., 92:d0:c6:0a:29:33)")
	...
	flags.StringVar(&copts.isolation, "isolation", "", "ContainerBs isolation technology")
