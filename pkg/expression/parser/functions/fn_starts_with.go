...
func (s *StartsWithFn) GetContainer() expression.IContainer {
	return s.Container
}

func (s *StartsWithFn) SetContainer(c expression.IContainer) {
	s.Container = c
}
...
func (s *StartsWithFn) ConvertToRealizedExpression(eCtx expression.IEvaluationContext) string {
