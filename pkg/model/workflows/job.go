...
type Job struct {
	...
	Needs JobNeeds `json:"needs,omitempty" yaml:"needs,omitempty" mapstructure:"needs,omitempty"`
	...
	Strategy Strategy `json:"strategy,omitempty" yaml:"strategy,omitempty" mapstructure:"strategy,omitempty"`
...
type JobSecrets struct {
	...
	Inherit bool `json:"inherit,omitempty" yaml:"inherit,omitempty" mapstructure:"inherit,omitempty"`
}
...
type Strategy struct {
	Matrix Evaluable[Matrix] `json:"matrix,omitempty" yaml:"matrix,omitempty" mapstructure:"matrix,omitempty"`
	// When set to true, GitHub cancels all in-progress jobs if any matrix job fails. Default: true
	// https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idstrategyfail-fast
	FailFast Evaluable[bool] `json:"fail-fast,omitempty" yaml:"fail-fast,omitempty" mapstructure:"fail-fast,omitempty"` // default: true
	...
	MaxParallel Evaluable[int64] `json:"max-parallel,omitempty" yaml:"max-parallel,omitempty" mapstructure:"max-parallel,omitempty"`
}
