...
type onEventWithTypes[T ~string] struct {
	Types []T `json:"types,omitempty" yaml:"types,omitempty"`
}
...
type On struct {
	...
	BranchProtectionRule *OnBranchProtectionRule `json:"branch_protection_rule,omitempty" yaml:"branch_protection_rule,omitempty"`
	...
	Create *OnCreate `json:"create,omitempty" yaml:"create,omitempty"`
	...
	Delete *OnDelete `json:"delete,omitempty" yaml:"delete,omitempty"`
	...
	Deployment *OnDeployment `json:"deployment,omitempty" yaml:"deployment,omitempty"`
	...
	DeploymentStatus *OnDeploymentStatus `json:"deployment_status,omitempty" yaml:"deployment_status,omitempty"`
	...
	Discussion *OnDiscussion `json:"discussion,omitempty" yaml:"discussion,omitempty"`
	...
	DiscussionComment *OnDiscussionComment `json:"discussion_comment,omitempty" yaml:"discussion_comment,omitempty"`
	...
	Fork *OnFork `json:"fork,omitempty" yaml:"fork,omitempty"`

	// Runs your workflow when someone creates or updates a Wiki page, which triggers the gollum event.
	// https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#gollum
	Gollum *OnGollum `json:"gollum,omitempty" yaml:"gollum,omitempty"`
	...
	Issues *OnIssues `json:"issues,omitempty" yaml:"issues,omitempty"`
	...
	Label *OnLabel `json:"label,omitempty" yaml:"label,omitempty"`
	...
	MergeGroup *OnMergeGroup `json:"merge_group,omitempty" yaml:"merge_group,omitempty"`
	...
	Milestone *OnMilestone `json:"milestone,omitempty" yaml:"milestone,omitempty"`
	...
	PageBuild *OnPageBuild `json:"page_build,omitempty" yaml:"page_build,omitempty"`
	...
	Project *OnProject `json:"project,omitempty" yaml:"project,omitempty"`
	...
	Public *OnPublic `json:"public,omitempty" yaml:"public,omitempty"`
	...
	Push *OnPush `json:"push,omitempty" yaml:"push,omitempty"`
	...
	Release *OnRelease `json:"release,omitempty" yaml:"release,omitempty"`
	...
	RepositoryDispatch *OnRepositoryDispatch `json:"repository_dispatch,omitempty" yaml:"repository_dispatch,omitempty"`
	...
	Schedule *OnSchedule `json:"schedule,omitempty" yaml:"schedule,omitempty"`
	...
	Status *OnStatus `json:"status,omitempty" yaml:"status,omitempty"`
	...
	Watch *OnWatch `json:"watch,omitempty" yaml:"watch,omitempty"`

	// Allows workflows to be reused by other workflows.
	// https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#workflow_call
	WorkflowCall *OnWorkflowCall `json:"workflow_call,omitempty" yaml:"workflow_call,omitempty"`
...
type OnPullRequest struct {
	onEventWithTypes[EventPullRequestActivity]
	onEventWithRef
}
...
type OnWorkflowRun struct {
	onEventWithTypes[EventWorkflowRunActivity]
	onEventWithRef
