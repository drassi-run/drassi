...
func (j *Join) Accept(eCtx interfaces.Context, v interfaces.Visitor) any {
...
func (j *Join) GetCtn() interfaces.Container {
	return j.Ctn
}

func (j *Join) SetCtn(c interfaces.Container) {
	j.Ctn = c
}
...
func (j *Join) RealizedExpr(eCtx interfaces.Context) string {
