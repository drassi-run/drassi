...
func (c *Contains) Accept(eCtx interfaces.Context, v interfaces.Visitor) any {
...
func (c *Contains) RealizedExpr(eCtx interfaces.Context) string {
...
func (c *Contains) GetCtn() interfaces.Container {
	return c.Ctn
}

func (c *Contains) SetCtn(cc interfaces.Container) {
	c.Ctn = cc
}
