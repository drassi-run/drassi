...
func FileAddPath[R cmdtypes.SupportAddPath]() *command.FileHandler[R] {
...
func FileSetEnv[R cmdtypes.SupportSetEnv](reporter cmdtypes.Reporter[R]) *command.FileHandler[R] {
	run := func(ctx context.Context, res R, r io.Reader) error {
...
func FileSaveState[R cmdtypes.SupportSaveState]() *command.FileHandler[R] {
	run := func(ctx context.Context, res R, r io.Reader) error {
...
func FileSetOutput[R cmdtypes.SupportSetOutput]() *command.FileHandler[R] {
	run := func(ctx context.Context, res R, r io.Reader) error {
...
func CreateStepSummary[R any](attacher cmdtypes.Attacher[R]) *command.FileHandler[R] {
	run := func(ctx context.Context, res R, r io.Reader) error {
