...
type BaseJob struct {
	...
	Name Evaluable[string] `json:"name,omitempty"`
	...
	Needs JobNeeds `json:"needs,omitempty"`
	...
	// https://docs.github.com/en/actions/learn-github-actions/contexts#context-availability
	If Conditional `json:"if,omitempty"`
	...
	// https://docs.github.com/en/actions/learn-github-actions/contexts#context-availability
	ContinueOnError Evaluable[bool] `json:"continue-on-error,omitempty"`
}
...
type NormalJob struct {
	...
	// https://docs.github.com/en/actions/learn-github-actions/contexts#context-availability
	Outputs Evaluable[map[string]string] `json:"outputs,omitempty"`
	...
	// Context available: `github`, `needs`, `strategy`, `matrix`, `vars`, `inputs`
	// https://docs.github.com/en/actions/learn-github-actions/contexts#context-availability
	TimeoutInMinutes Evaluable[int64] `json:"timeout-minutes,omitempty"`
	...
	Container Evaluable[*Container] `json:"container,omitempty"`
	...
	Services Evaluable[map[string]*Container] `json:"services,omitempty"`
}
...
type ReusableWorkflowCallJob struct {
	...
	// https://docs.github.com/en/actions/learn-github-actions/contexts#context-availability
	With Evaluable[map[string]string] `json:"with,omitempty"`
	...
	Secrets Evaluable[JobSecrets] `json:"secrets,omitempty"`
}
...
type Strategy struct {
	Matrix Evaluable[Matrix] `json:"matrix,omitempty"`
	// When set to true, GitHub cancels all in-progress jobs if any matrix job fails. Default: true
	// https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idstrategyfail-fast
	FailFast Evaluable[bool] `json:"fail-fast,omitempty"` // default: true
	...
	MaxParallel Evaluable[int64] `json:"max-parallel,omitempty"`
}
