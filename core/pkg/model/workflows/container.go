...
type Container struct {
	...
	Credentials *ContainerCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty" actions:"credentials,omitempty"`
	...
	Ports []string `json:"ports,omitempty" yaml:"ports,omitempty" actions:"ports,omitempty"`
	...
	Volumes []string `json:"volumes,omitempty" yaml:"volumes,omitempty" actions:"volumes,omitempty"`
...
type ContainerCredentials struct {
	Username string `json:"username,omitempty" yaml:"username,omitempty" actions:"username,omitempty"`
	Password string `json:"password,omitempty" yaml:"password,omitempty" actions:"password,omitempty"`
}
