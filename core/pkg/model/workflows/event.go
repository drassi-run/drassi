...
type onEventWithTypes[T ~string] struct {
	Types []T `json:"types,omitempty" yaml:"types,omitempty" actions:"types,omitempty"`
}
type onEventWithRef struct {
	Branches       []string `json:"branches,omitempty" yaml:"branches,omitempty" actions:"branches,omitempty"`
	Tags           []string `json:"tags,omitempty" yaml:"tags,omitempty" actions:"tags,omitempty"`
	Paths          []string `json:"paths,omitempty" yaml:"paths,omitempty" actions:"paths,omitempty"`
	BranchesIgnore []string `json:"branches-ignore,omitempty" yaml:"branches-ignore,omitempty" actions:"branches-ignore,omitempty"`
	TagsIgnore     []string `json:"tags-ignore,omitempty" yaml:"tags-ignore,omitempty" actions:"tags-ignore,omitempty"`
	PathsIgnore    []string `json:"paths-ignore,omitempty" yaml:"paths-ignore,omitempty" actions:"paths-ignore,omitempty"`
}
...
type On struct {
	...
	BranchProtectionRule *OnBranchProtectionRule `json:"branch_protection_rule,omitempty" yaml:"branch_protection_rule,omitempty" actions:"branch_protection_rule,omitempty"`
	...
	CheckRun *OnCheckRun `json:"check_run,omitempty" yaml:"check_run,omitempty" actions:"check_run,omitempty"`
	...
	CheckSuite *OnCheckSuite `json:"check_suite,omitempty" yaml:"check_suite,omitempty" actions:"check_suite,omitempty"`
	...
	Create *OnCreate `json:"create,omitempty" yaml:"create,omitempty" actions:"create,omitempty"`
	...
	Delete *OnDelete `json:"delete,omitempty" yaml:"delete,omitempty" actions:"delete,omitempty"`
	...
	Deployment *OnDeployment `json:"deployment,omitempty" yaml:"deployment,omitempty" actions:"deployment,omitempty"`
	...
	DeploymentStatus *OnDeploymentStatus `json:"deployment_status,omitempty" yaml:"deployment_status,omitempty" actions:"deployment_status,omitempty"`
	...
	Discussion *OnDiscussion `json:"discussion,omitempty" yaml:"discussion,omitempty" actions:"discussion,omitempty"`
	...
	DiscussionComment *OnDiscussionComment `json:"discussion_comment,omitempty" yaml:"discussion_comment,omitempty" actions:"discussion_comment,omitempty"`
	...
	Fork *OnFork `json:"fork,omitempty" yaml:"fork,omitempty" actions:"fork,omitempty"`

	// Runs your workflow when someone creates or updates a Wiki page, which triggers the gollum event.
	// https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#gollum
	Gollum *OnGollum `json:"gollum,omitempty" yaml:"gollum,omitempty" actions:"gollum,omitempty"`
	...
	IssueComment *OnIssueComment `json:"issue_comment,omitempty" yaml:"issue_comment,omitempty" actions:"issue_comment,omitempty"`
	...
	Issues *OnIssues `json:"issues,omitempty" yaml:"issues,omitempty" actions:"issues,omitempty"`
	...
	Label *OnLabel `json:"label,omitempty" yaml:"label,omitempty" actions:"label,omitempty"`
	...
	MergeGroup *OnMergeGroup `json:"merge_group,omitempty" yaml:"merge_group,omitempty" actions:"merge_group,omitempty"`
	...
	Milestone *OnMilestone `json:"milestone,omitempty" yaml:"milestone,omitempty" actions:"milestone,omitempty"`
	...
	PageBuild *OnPageBuild `json:"page_build,omitempty" yaml:"page_build,omitempty" actions:"page_build,omitempty"`
	...
	Project *OnProject `json:"project,omitempty" yaml:"project,omitempty" actions:"project,omitempty"`
	...
	ProjectCard *OnProjectCard `json:"project_card,omitempty" yaml:"project_card,omitempty" actions:"project_card,omitempty"`
	...
	ProjectColumn *OnProjectColumn `json:"project_column,omitempty" yaml:"project_column,omitempty" actions:"project_column,omitempty"`
	...
	Public *OnPublic `json:"public,omitempty" yaml:"public,omitempty" actions:"public,omitempty"`
	...
	PullRequest *OnPullRequest `json:"pull_request,omitempty" yaml:"pull_request,omitempty" actions:"pull_request,omitempty"`
	...
	PullRequestReview *OnPullRequestReview `json:"pull_request_review,omitempty" yaml:"pull_request_review,omitempty" actions:"pull_request_review,omitempty"`
	...
	PullRequestReviewComment *OnPullRequestReviewComment `json:"pull_request_review_comment,omitempty" yaml:"pull_request_review_comment,omitempty" actions:"pull_request_review_comment,omitempty"`
	...
	PullRequestTarget *OnPullRequestTarget `json:"pull_request_target,omitempty" yaml:"pull_request_target,omitempty" actions:"pull_request_target,omitempty"`
	...
	Push *OnPush `json:"push,omitempty" yaml:"push,omitempty" actions:"push,omitempty"`
	...
	RegistryPackage *OnRegistryPackage `json:"registry_package,omitempty" yaml:"registry_package,omitempty" actions:"registry_package,omitempty"`
	...
	Release *OnRelease `json:"release,omitempty" yaml:"release,omitempty" actions:"release,omitempty"`
	...
	RepositoryDispatch *OnRepositoryDispatch `json:"repository_dispatch,omitempty" yaml:"repository_dispatch,omitempty" actions:"repository_dispatch,omitempty"`
	...
	Schedule *OnSchedule `json:"schedule,omitempty" yaml:"schedule,omitempty" actions:"schedule,omitempty"`
	...
	Status *OnStatus `json:"status,omitempty" yaml:"status,omitempty" actions:"status,omitempty"`
	...
	Watch *OnWatch `json:"watch,omitempty" yaml:"watch,omitempty" actions:"watch,omitempty"`

	// Allows workflows to be reused by other workflows.
	// https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#workflow_call
	WorkflowCall *OnWorkflowCall `json:"workflow_call,omitempty" yaml:"workflow_call,omitempty" actions:"workflow_call,omitempty"`
	...
	WorkflowDispatch *OnWorkflowDispatch `json:"workflow_dispatch,omitempty" yaml:"workflow_dispatch,omitempty" actions:"workflow_dispatch,omitempty"`
	...
	WorkflowRun *OnWorkflowRun `json:"workflow_run,omitempty" yaml:"workflow_run,omitempty" actions:"workflow_run,omitempty"`
}
...
type OnPullRequest struct {
	onEventWithTypes[EventPullRequestActivity] `yaml:",inline" actions:",squash"`
	onEventWithRef                             `yaml:",inline" actions:",squash"`
}
...
type OnPullRequestTarget struct {
	onEventWithTypes[EventPullRequestTargetActivity] `yaml:",inline" actions:",squash"`
	onEventWithRef                                   `yaml:",inline" actions:",squash"`
}
...
type OnSchedule []struct {
	...
	Cron string `json:"cron,omitempty" yaml:"cron,omitempty" actions:"cron,omitempty"`
}
type OnStatus = empty
...
type OnWorkflowCall struct {
	...
	Secrets map[string]Secret `json:"secrets,omitempty" yaml:"secrets,omitempty" actions:"secrets,omitempty"`
}
...
type OnWorkflowRun struct {
	onEventWithTypes[EventWorkflowRunActivity] `yaml:",inline" actions:",squash"`
	onEventWithRef                             `yaml:",inline" actions:",squash"`

	Workflows []string `json:"workflows,omitempty" yaml:"workflows,omitempty" actions:"workflows,omitempty"`
}
