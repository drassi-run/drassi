...
func unmarshalJSON[T any](t *testing.T, s string) T {
	t.Helper()
	var v T
...
func unmarshalJSONErr[T any](t *testing.T, s string) error {
	t.Helper()
	var v T
	err := json.Unmarshal([]byte(s), &v)
	require.Error(t, err)
...
func TestMountUnmarshalJSON(t *testing.T) {
	t.Run("shorthand string volume", func(t *testing.T) {
		m := unmarshalJSON[types.Mount](t, `"/var/run/docker.sock:/var/run/docker.sock:ro"`)
	...
	t.Run("object volume", func(t *testing.T) {
		m := unmarshalJSON[types.Mount](t, `{"type": "volume", "source": "my-vol", "target": "/data", "read_only": false}`)
...
func TestPortBindingUnmarshalJSON(t *testing.T) {
	t.Run("shorthand string port without host ip", func(t *testing.T) {
		pb := unmarshalJSON[types.PortBinding](t, `"8080:80"`)
	...
	t.Run("shorthand string port with host ip and protocol", func(t *testing.T) {
		pb := unmarshalJSON[types.PortBinding](t, `"127.0.0.1:3000:3000/udp"`)
	...
	t.Run("object port binding", func(t *testing.T) {
		pb := unmarshalJSON[types.PortBinding](t, `{"host_ip": "0.0.0.0", "host_port": 9000, "container_port": 9000, "protocol": "tcp"}`)
...
func TestContainerSpecUnmarshalJSON(t *testing.T) {
	...
	spec := unmarshalJSON[types.ContainerSpec](t, raw)
...
func TestMappingUnmarshalJSON(t *testing.T) {
	t.Run("object mapping", func(t *testing.T) {
		raw := `{"FOO": "bar", "PORT": "8080", "BOOL": "true"}`
		m := unmarshalJSON[types.Mapping](t, raw)
	...
	t.Run("null mapping", func(t *testing.T) {
		m := unmarshalJSON[types.Mapping](t, "null")
		require.Nil(t, m)
	})
}
...
func TestPortUnmarshalJSON(t *testing.T) {
	t.Run("port from string number", func(t *testing.T) {
		p := unmarshalJSON[types.Port](t, `"80"`)
	...
	t.Run("port from string with protocol", func(t *testing.T) {
		p := unmarshalJSON[types.Port](t, `"53/udp"`)
	...
	t.Run("port from integer number", func(t *testing.T) {
		p := unmarshalJSON[types.Port](t, `443`)
		require.Equal(t, uint16(443), p.Number)
		require.Equal(t, "tcp", p.Protocol)
	})

	t.Run("port from object", func(t *testing.T) {
		p := unmarshalJSON[types.Port](t, `{"number": 8080, "protocol": "tcp"}`)
...
func TestUnitBytesUnmarshalJSON(t *testing.T) {
	t.Run("from integer number", func(t *testing.T) {
		u := unmarshalJSON[types.UnitBytes](t, `2147483648`)
	...
	t.Run("from human-readable unit strings", func(t *testing.T) {
		...
		for _, tc := range cases {
			u := unmarshalJSON[types.UnitBytes](t, tc.input)
			require.Equal(t, tc.expected, u)
		}
	})

	t.Run("invalid string returns error", func(t *testing.T) {
		err := unmarshalJSONErr[types.UnitBytes](t, `"invalid-size"`)
		require.Error(t, err)
	})
}
