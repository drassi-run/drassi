...
func TestContainerSpecUnmarshalJSON(t *testing.T) {
	...
	require.Equal(t, UnitBytes(2147483648), spec.Memory)
	require.Equal(t, UnitBytes(1073741824), spec.ShmSize)
}
...
func TestUnitBytesUnmarshalJSON(t *testing.T) {
	t.Run("from integer number", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Equal(t, UnitBytes(2147483648), u)
...
func TestContainerSpecShortFormUnmarshalJSON(t *testing.T) {
	...
	require.Equal(t, UnitBytes(2*1024*1024*1024), spec.Memory)
	require.Equal(t, UnitBytes(1024*1024*1024), spec.MemReservation)
	require.Equal(t, UnitBytes(64*1024*1024), spec.ShmSize)
}
