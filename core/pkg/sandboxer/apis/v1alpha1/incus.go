...
type IncusSandboxer struct {
	...
	Spec IncusSandboxerSpec `json:"spec,omitempty"`
}

type IncusSandboxerSpec struct {
	Endpoint string        `json:"endpoint"`
	Template IncusTemplate `json:"template,omitempty"`
}
...
type IncusTemplate struct {
	...
	Image string `json:"source,omitempty"`
