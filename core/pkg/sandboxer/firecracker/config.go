...
type Config struct {
	...
	GuestIP       string   `toml:"guest_ip,omitempty" json:"guestIP,omitempty"`
	GuestGateway  string   `toml:"guest_gateway,omitempty" json:"guestGateway,omitempty"`
	GuestDNS      []string `toml:"guest_dns,omitempty" json:"guestDNS,omitempty"`
	GuestIface    string   `toml:"guest_iface,omitempty" json:"guestIface,omitempty"`
