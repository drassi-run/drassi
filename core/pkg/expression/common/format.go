...
// max bitSize: 32. Int with value larger than math.MaxInt32 is evaluated to float64
...
func FormatValue(masker secret_masker.Interface, value any, kind expression.ResultKind) string {
	switch kind {
...
func ToCanonicalValue(input any) (value any, kind expression.ResultKind) {
	switch input.(type) {
	case nil:
