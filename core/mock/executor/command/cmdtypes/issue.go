...
// Source: ../pkg/executor/command/cmdtypes/issue.go
//
// Generated by this command:
//
//	mockgen -source=../pkg/executor/command/cmdtypes/issue.go -destination=executor/command/cmdtypes/issue.go -typed
//
...
import (
	...
	cmdtypes "drassi.run/core/pkg/executor/command/cmdtypes"
...
func (m *MockReporter[R]) AddIssue(ctx context.Context, res R, issue *cmdtypes.Issue) error {
	m.ctrl.T.Helper()
...
func (c *MockReporterAddIssueCall[R]) Do(f func(context.Context, R, *cmdtypes.Issue) error) *MockReporterAddIssueCall[R] {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockReporterAddIssueCall[R]) DoAndReturn(f func(context.Context, R, *cmdtypes.Issue) error) *MockReporterAddIssueCall[R] {
